    ...
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      {holdings && (
        <>
          ...
          <div className="mt-3 overflow-x-auto rounded-xl border border-[#DDE2E9] bg-white">
              ...
              <tbody>
                {holdings.map((h) => (
                  <tr key={h.id} className="border-b border-[#EEF0F3] last:border-0">
                    ...
                    <td className="px-4 py-3 font-mono text-[#5B6576] whitespace-nowrap">{h.ticker}</td>
                    <td className="px-4 py-3 text-right font-mono whitespace-nowrap">
                      {h.value ? h.value.toLocaleString("de-DE") + " €" : "—"}
                    </td>
                    <td className="px-4 py-3 text-right font-mono whitespace-nowrap">{h.weight}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
